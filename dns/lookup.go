...
// DNS Toolkit — Look up a specific DNS record type for a domain
// Usage: export TOOLKITAPI_KEY=tk_live_...; go run lookup.go
package main
...
func main() {
	...
	result, err := dns.Lookup(context.Background(), map[string]string{
