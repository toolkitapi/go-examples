...
// DNS Toolkit — Generate typosquatting variants of a domain
// Usage: export TOOLKITAPI_KEY=tk_live_...; go run typosquat.go
package main
...
func main() {
	...
	result, err := dns.Typosquat(context.Background(), map[string]string{
