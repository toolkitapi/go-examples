...
// DNS Toolkit — Look up all DNS record types for a domain
// Usage: export TOOLKITAPI_KEY=tk_live_...; go run lookup_all.go
package main
...
func main() {
	...
	result, err := dns.LookupAll(context.Background(), map[string]string{
