...
// Image Toolkit — Extract dominant colors from an image
// Usage: export TOOLKITAPI_KEY=tk_live_...; go run colors.go
package main
...
func main() {
	...
	result, err := img.ImageExtractColorsColors1(context.Background(), map[string]string{
		"url": imageURL,
	})
	if err != nil {
