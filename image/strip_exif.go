...
// Image Toolkit — Strip EXIF metadata from an image
// Usage: export TOOLKITAPI_KEY=tk_live_...; go run strip_exif.go
package main
...
func main() {
	...
	result, err := img.ImageStripExif(context.Background(), map[string]string{
		"url": imageURL,
	})
	if err != nil {
