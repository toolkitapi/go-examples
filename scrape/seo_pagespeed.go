...
// Scrape Toolkit — Run a PageSpeed / Core Web Vitals check
// Usage: export TOOLKITAPI_KEY=tk_live_...; go run seo_pagespeed.go
package main
...
func main() {
	...
	result, err := sc.SeoPagespeed(context.Background(), map[string]string{
